      ...
      <div className="absolute inset-0 flex">
        <div className="flex flex-auto flex-col items-start justify-center pb-4 pl-4 pr-4 pt-12 md:pl-[54px] md:pr-[108px] lg:w-2/3 lg:pl-[108px]">
          ...
          <div className="pb-2 pt-2 sm:pb-10 sm:pt-6 md:pb-12">
            <p className="font-inter gap-x-6 text-[8px] font-normal leading-6 text-white sm:text-[16px] md:leading-9 2xl:text-2xl ">
...
The website showcases the quality, genomic content, and taxonomic annotations of MAGs obtained through PacBio HiFi sequencing.
          ...
          <div>
            <p className="font-inter gap-x-6 text-sm font-normal leading-6 text-white sm:text-[16px] md:leading-9 2xl:text-2xl ">
